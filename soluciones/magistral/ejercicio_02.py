...
#El programa debe estar en un archivo llamado "ApellidoNombre_MagistralEjercicio02.py" donde Apellido y Nombre debe reemplazarlos con su apellido y nombre. Suba ese archivo como respuesta a esta actividad.
